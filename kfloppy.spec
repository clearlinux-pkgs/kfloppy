...
Source0  : https://download.kde.org/stable/release-service/20.08.0/src/kfloppy-20.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.08.0/src/kfloppy-20.08.0.tar.xz.sig
...
%prep
%setup -q -n kfloppy-20.08.0
cd %{_builddir}/kfloppy-20.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597781630
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kfloppy-20.08.0/COPYING %{buildroot}/usr/share/package-licenses/kfloppy/7c203dee3a03037da436df03c4b25b659c073976
pushd clr-build
%make_install
popd
%find_lang kfloppy
