...
Source0  : https://download.kde.org/stable/release-service/20.04.2/src/kfloppy-20.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.04.2/src/kfloppy-20.04.2.tar.xz.sig
...
%prep
%setup -q -n kfloppy-20.04.2
cd %{_builddir}/kfloppy-20.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591903558
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kfloppy-20.04.2/COPYING %{buildroot}/usr/share/package-licenses/kfloppy/7c203dee3a03037da436df03c4b25b659c073976
pushd clr-build
%make_install
popd
%find_lang kfloppy
